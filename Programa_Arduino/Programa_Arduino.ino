 ...
 if(Serial.available()> 0){
    ...
    int input = Serial.read();
      ...
      if(input == 'a'){
          delay(3000);
          servoMotor.write(90);
          for (pos = 90; pos <= 180; pos += 1){servoMotor2.write(pos);delay(7);}
          delay(3000);
          for (pos = 180; pos >= 90; pos -= 1){servoMotor2.write(pos);delay(7);}
          delay(500);
          servoMotor.write(20);
          delay(500);
          for (pos = 90; pos <= 180; pos += 1) {servoMotor2.write(pos);delay(7);}
          ...
          Serial.println("servoMotor.write(90);");
          Serial.println("for (pos = 90; pos <= 180; pos += 1){servoMotor2.write(pos);delay(7);}");
          Serial.println("delay(3000);");
          Serial.println("for (pos = 180; pos >= 90; pos -= 1){servoMotor2.write(pos);delay(7);}");
      ...
      if(input == 'x'){
          for (pos = 90; pos <= 180; pos += 1){servoMotor2.write(pos);delay(15);}
          servoMotor2.write(180);
          Serial.println(" for (pos = 90; pos <= 180; pos += 1){servoMotor2.write(pos);delay(15);}");
          Serial.println("servoMotor2.write(180);");
      }
      
      if(input == 'y'){
          for (pos = 180; pos >= 90; pos -= 1){servoMotor2.write(pos);delay(15);}
          servoMotor2.write(90);
          Serial.println("for (pos = 180; pos >= 90; pos -= 1){servoMotor2.write(pos);delay(15);}");
          Serial.println(" servoMotor2.write(90);");
      }
